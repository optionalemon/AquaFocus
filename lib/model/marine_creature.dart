...
List<MarineCreatures> marinesCreatures = [
  ...
  MarineCreatures(id: 4, image: "assets/images/axolotl.png", type: "Axolotl", price: 1200, description: "Usually found in Mexico freshwater lakes and ponds, critically endangered due to urbanisation and water pollution in Mexico.", color: Color.fromARGB(255, 236, 143, 147)),
  MarineCreatures(id: 5, image: "assets/images/MantaRay.png", type: "Manta Ray", price: 1800, description: "I may look hazardous but I only have 300 tiny teeth that cannot penetrate human skin.", color: Color.fromARGB(255, 162, 162, 162)),
];
